...
So the data can be accessed by both search and submit users to ensure they comply to the Government's Product and Safety Standards
  ...
  Scenario: Verify Creation of Product Notification (Nanomaterials / multi-items / no CMR substances / Ingredient csv fixed  - Happy Path - COSBETA-2065, COSBETA-2067, COSBETA-2072, COSBETA-2076)
    ...
    #complete the items section
    When the user enters the item information with no CMR substances
    Then the items section is completed successfully   
  
  Scenario: Verify Creation of Product Notification (No nanomaterials / no multi-items / no CMR substances / Ingredient csv range - Happy Path - COSBETA-2066, COSBETA-2070, COSBETA-2077)
    #authenticate responsible person
    #Given the user visits the SCPN login page
    #When the user logs into SCPN
    #Then the user successfully authenticates using their verification code
