...
So the data can be accessed by both search and submit users to ensure they comply to the Government's Product and Safety Standards
  ...
  Scenario: Verify Creation of Product Notification (No nanomaterials / no multi-items / no CMR substances - Happy Path - COSBETA-2066, COSBETA-2070, COSBETA-2077)
  ...
  @test
  Scenario: Verify Creation of Product Notification (Nanomaterials / multi-items / no CMR substances /  - Happy Path - COSBETA-2065, COSBETA-2067, COSBETA-2072, COSBETA-2076)
    #authenticate responsible person
    Given the user visits the SCPN login page
    When the user logs into SCPN
    Then the user successfully authenticates using their verification code
